class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:client_id, :status, :client_name, order_items_attributes: [:id, :product_id, :product_name, :quantity, :quantity_formatted, :unit_price, :_destroy])
    end
end
