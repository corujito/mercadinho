...
if Product.count == 0
  Product.create!(full_name: "Cerveja Itaipava", unity: 1, in_stock: 50)
  Product.create!(full_name: "Cerveja Original", unity: 1, in_stock: 50)
  Product.create!(full_name: "Coca Cola", unity: 1, in_stock: 50)
  Product.create!(full_name: "Açucar União", unity: 3, in_stock: 50)
  Product.create!(full_name: "Óleo de soja", unity: 1, in_stock: 50)
  Product.create!(full_name: "Picanha", unity: 3, in_stock: 50)
end
...
if Card.count == 0
  ...
  Card.create!(full_name: "Fabiana Salve", identification: "112233112233", password: "123", cpf: "", phone: "", email: "")
